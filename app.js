...
const namesArray = (inventor) => {
    return {
        first: inventor.first,
        Last:  inventor.last,
}}
inventorNames = inventors.map(namesArray)

// inventorNames = inventors.filter((inventor) => {
...
const oldestInventor = inventors[5].year
const youngestInventor = inventors[7].year
